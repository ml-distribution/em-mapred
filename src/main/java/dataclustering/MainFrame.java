...
public class MainFrame extends javax.swing.JFrame implements ActionListener, PropertyChangeListener {
	...
	private static final long serialVersionUID = -9189224516635454671L;
	...
	private void initComponents() {
		...
		jLabel1DistanceFormula.setIcon(new javax.swing.ImageIcon(
				"C:\\Users\\Thuan Loc\\Documents\\NetBeansProjects\\Data Clustering\\Picture\\Euclidean_Distance.png")); // NOI18N

		jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Additional Configuration",
				...
				.addGroup(
						jPanel2Layout
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 38,
										Short.MAX_VALUE)
								.addComponent(jTextFieldIterations, javax.swing.GroupLayout.PREFERRED_SIZE, 158,
		...
		jPanelSpecificationLayout
				.setHorizontalGroup(jPanelSpecificationLayout
						...
						.addGroup(
								jPanelSpecificationLayout
																				...
																				jPanelSpecificationLayout
																						...
																						.addGroup(
																								jPanelSpecificationLayout
																										...
																										.addComponent(
																												jTextFieldFileChoice,
																												javax.swing.GroupLayout.PREFERRED_SIZE,
																												294,
																												javax.swing.GroupLayout.PREFERRED_SIZE)
																										.addComponent(
																												jProgressBarTestFile,
																												javax.swing.GroupLayout.DEFAULT_SIZE,
																												294,
																												Short.MAX_VALUE))
																						.addGap(18, 18, 18)
										...
										.addGap(45, 45, 45)));
		jPanelSpecificationLayout
				.setVerticalGroup(jPanelSpecificationLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jPanelSpecificationLayout
										.createSequentialGroup()
																						...
																						.addGroup(
																								...
																								jPanelSpecificationLayout
																										...
																										.addGap(24, 24,
																												24)
																										.addComponent(
																												jLabelDistanceMeasureDiscription)
																										.addGap(18, 18,
																												18)
																										.addComponent(
																												jLabel1DistanceFormula)
																										.addGap(70, 70,
																												70)
																										.addComponent(
																												jPanel2,
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null, null, null, null },
				...
				{ null, null, null, null, null } }, new String[] { "Cluster No", "NOf Objects", "Centroid's X",
				"Centroid's Y", "Centroid's Z" }) {

			private static final long serialVersionUID = 3354837767818308376L;
												...
												.addGroup(
														...
														jPanel1Layout
																...
																.addComponent(jLabel4,
																		...
																		javax.swing.GroupLayout.PREFERRED_SIZE))
												.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 403,
														Short.MAX_VALUE)).addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						jPanel1Layout
								.createSequentialGroup()
								.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 553,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(
										jPanel1Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jButton2, javax.swing.GroupLayout.DEFAULT_SIZE, 48,
														Short.MAX_VALUE)
		...
		jPanelPerformanceLayout.setHorizontalGroup(jPanelPerformanceLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				jPanelPerformanceLayout
						.createSequentialGroup()
						.addComponent(ClusteringPanelChart, javax.swing.GroupLayout.PREFERRED_SIZE, 720,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanelPerformanceLayout.setVerticalGroup(jPanelPerformanceLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 1144, Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jTabbedPane, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 648,
				Short.MAX_VALUE));
	...
	private void jRadioButtonMenuItemEMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonMenuItemEMActionPerformed
		...
		jLabelDistanceMeasureDiscription.setText("The most popular distance measure which is defined as");
		jLabel1DistanceFormula.setIcon(new javax.swing.ImageIcon(
				"C:\\Users\\Thuan Loc\\Documents\\NetBeansProjects\\Data Clustering\\Picture\\Euclidean_Distance.png"));
	...
	private void jRadioButtonManhattanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonManhattanActionPerformed
		...
		jLabel1DistanceFormula.setIcon(new javax.swing.ImageIcon(
				"C:\\Users\\Thuan Loc\\Documents\\NetBeansProjects\\Data Clustering\\Picture\\Manhattan_Distance.png"));
	...
	private void jButtonAnalysisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnalysisActionPerformed
		...
		if (this.jRadioButtonMenuItemBasicKMeans.isSelected()) {
			Thread thread = new ChartThread(CONST.BASIC_KMEANS, this.VP, K, MaxLoops, this.ClusteringPanelChart,
					this.jTable1, jLabel4, jButton2, jTabbedPane, DistanceType);
			thread.start();
		} else if (this.jRadioButtonMenuItemBisectingKMeans.isSelected()) {
			Thread thread = new ChartThread(CONST.BISECTING_KMEANS, this.VP, K, MaxLoops, this.ClusteringPanelChart,
					this.jTable1, jLabel4, jButton2, jTabbedPane, DistanceType);
			thread.start();
		} else if (this.jRadioButtonMenuItemEM.isSelected()) {
			Thread thread = new ChartThread(CONST.EM_KMEANS, this.VP, K, MaxLoops, this.ClusteringPanelChart,
					this.jTable1, jLabel4, jButton2, jTabbedPane, DistanceType);
			thread.start();
		} else if (this.jRadioButtonMenuItemKMedoids.isSelected()) {
			Thread thread = new ChartThread(CONST.K_MEDOIDS, this.VP, K, MaxLoops, this.ClusteringPanelChart,
					this.jTable1, jLabel4, jButton2, jTabbedPane, DistanceType);
			thread.start();
		}
