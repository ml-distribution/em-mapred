...
class MyUtil {
	...
	public static void drawGaussian(Graphics g, Matrix center, Matrix covar, Color c, int size) {
		...
		g2.setTransform(new AffineTransform(t.get(0, 0), t.get(1, 0), t.get(0, 1), t.get(1, 1), center.get(0, 0),
				center.get(1, 0)));
...
class EMofGMM extends JFrame {
	...
	private static final long serialVersionUID = 5735522367586353196L;
	...
	public EMofGMM() {
		...
		JPanel c = new JPanel() {
			...
			private static final long serialVersionUID = 4990646349157746358L;
