...
public class SequenceEM {
	...
	private static void printAccuracy(String filename, double[][] posteriors, boolean firstIsHuman) throws IOException {
		...
		for (int i = 0; i < posteriors.length; i++) {
			...
			boolean predictedIsHuman = (predictedIsFirst && firstIsHuman) || (!predictedIsFirst && !firstIsHuman);
