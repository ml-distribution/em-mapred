...
public class BaumWelchTest {
	...
	public static void main(String[] args) throws Exception {
		if (args.length != 3) {
			System.err.println("Usage: java BaumWelchTest sequence.fa key.fa convergencefactor");
			System.exit(1);
		}
		...
		int numStates = 2;
		Sequence sequence = new Sequence(sequenceFile), key = new Sequence(keyFile);

		HiddenMarkovModel hmm = BaumWelch.infer(sequence.getBody(), numStates, converge);
